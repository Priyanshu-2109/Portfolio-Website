...
const AchievementsSection = () => {
  return (
    <div className="py-10 px-6 sm:py-15 sm:px-12">
      <div className="border border-[#33353F] rounded-lg py-10 px-8 flex flex-wrap items-center justify-center sm:justify-between gap-6 sm:gap-12 w-full max-w-[95%] mx-auto">
